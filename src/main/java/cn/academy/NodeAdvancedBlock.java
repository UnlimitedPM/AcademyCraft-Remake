...
public class NodeAdvancedBlock extends Block {
    ...
    public void updateEnergyState(Level level, BlockPos pos, int currentEnergy, boolean isConnected) {
        ...
        if (state.is(this)) {
            int nextLevel = 0;
            if (currentEnergy >= 175000) nextLevel = 4;
            else if (currentEnergy >= 125000) nextLevel = 3;
            else if (currentEnergy >= 75000) nextLevel = 2;
            else if (currentEnergy >= 25000) nextLevel = 1;
